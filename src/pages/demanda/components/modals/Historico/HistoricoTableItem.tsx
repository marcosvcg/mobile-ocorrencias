  ...
  return (
    <>
      ...
      <tr>
        ...
        style={{
          backgroundColor: obterCorPeloStatus(demanda.historico[ordem].status)
          }}>
      ...
      <tr>
        <th>Órgão/Setor:</th>
        <td>{demanda.historico[ordem].orgao_nome}
      ...
      <tr>
        <th>Tramitado em:</th>
        <td>{new Date(demanda.historico[ordem].created_at).toLocaleString()}</td>
      </tr>
      <tr>
        <th>Atendente:</th>
        <td>{demanda.historico[ordem].atendente_nome
